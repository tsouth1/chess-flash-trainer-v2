...
/**
 * Standard chess piece artwork.
 *
 * Source: Wikimedia Commons, "Category:SVG chess pieces"
 * (https://commons.wikimedia.org/w/index.php?curid=1499810)
 * Original author: Colin M.L. Burnett (en:User:Cburnett) - Own work
 * License: CC BY-SA 3.0 Unported (https://creativecommons.org/licenses/by-sa/3.0/)
 *
 * Adapted from the React port in Clariity/react-chessboard (MIT-licensed
 * project, but its src/pieces.tsx carries this same Cburnett/CC BY-SA 3.0
 * credit inline - the artwork itself is still CC BY-SA, only the React
 * wrapper code is MIT). Full attribution notice: see LICENSE.md at the
 * project root, as required by CC BY-SA.
 *
 * Modification from the original: black pieces' outline (stroke) color was
 * changed from black to a light cream (#e9e4d5) so they stay legible
 * against this app's dark board squares - the original artwork assumes a
 * light board background, where a black-on-black outline still reads fine.
 * Geometry (the actual path data) is untouched.
 */
  ...
  bN: () => (
    ...
    >
      ...
      >
        <path
          d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18"
          style={{ fill: '#000000', stroke: '#e9e4d5' }}
        />
        <path
          d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10"
          style={{ fill: '#000000', stroke: '#e9e4d5' }}
    ...
    >
      ...
      >
        ...
        <path
          ...
          style={{ fill: 'none', stroke: '#e9e4d5', strokeLinecap: 'butt' }}
        />
  ...
  bK: () => (
    ...
    >
      ...
      >
        <path
          d="M 22.5,11.63 L 22.5,6"
          style={{ fill: 'none', stroke: '#e9e4d5', strokeLinejoin: 'miter' }}
          id="path6570"
        />
        <path
          d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25"
